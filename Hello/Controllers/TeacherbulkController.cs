...
{
    public class TeacherbulkController : Controller
    {
        public IActionResult Teacherbulk()
        {
            return View();
        }
        ...
        public async Task<IActionResult> Import(IFormFile file)
        {
            ...
            var list = new List<Teachersignup>();
            ...
            return RedirectToAction("Teacherbulk", "Teacherbulk");
